...
**Wipro**, http://www.wipro.com/ (Atlanta, GA):  
  **Lead Architect, UHG** : 11/2023 - Present
 
  * Lead Architect for MS Azure based AI/ML Smart Routing Solution
  * Used Azure ML models to intelligently route calls to correct routing queue
  * Used Databricks / Azure DataFactory to extract and shape data for models
  * Architected Infrastrucure for solution and created Terraform / IAC
  * Solution yielded 40% less caller wait time and improved customer satisfaction.
