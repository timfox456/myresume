...
* **DotNet**: C#, .NET, .NETCore, ML.NET, Microsoft Certified Professional (MCP), MCTS
...
**Scaia**, http://www.scaia.ai/ (Houston, TX):   (Startup)
  ...
  * Transferred Huggingface Models to backend .NET/C# application using ML.NET
  * Deployed Models in Microsoft Azure using .NET Core microservice applications
...
**Macy's Online**, (San Francisco, CA):  Consulting Data Engineer 02/2017 - 01/2019
  ...
  * Integrated ML Serving with C#/dotNet backend
...
**Wal-Mart**, (Bentonville, AR): Consulting Big Data Architect 11/2015 - 01/2017
  ...
  * Integrated solution with C#/dotNet backend
