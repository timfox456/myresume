...
Machine Learning and Computer Vision Engineer and Consultant
...
* **Image Recognition**: CNN, ResNET, Inception, Volumetric Data (Voexel)
...
**Scaia**, http://www.scaia.ai/ (Houston, TX):   (Startup)
  ...
  * Used PyTorch (Deep Learning), HuggingFace for transformation
  * Prepared data with OpenCV / Performed Feature Engineering  
  * Developed Model Code in C++
  * Used Vision Tranformers for Depth Estimation problems
  * Used 2D ConvNET for feature extraction from data
...
**Wake Forest University** (Winston Salem, NC):  
  ...
  * Performed research on application of MLtechniques to Genomics
  * Developed scalable ways to process large genomicdataset
...
**Macy's Online**, (San Francisco, CA):  Consulting Data Engineer 02/2017 - 01/2019
  ...
  * Implemented Tensorflow/Keras model for object recognition and extraction
  * Trained and deployed predictive model for online and mobile.
...
**Geophysical Insights**, Houston, TX, Consulting Data Scientist 01/2011 - 02/2012
  ...
  * Voxel ANalyiss in 3-D Volumetric / Voxel Data
